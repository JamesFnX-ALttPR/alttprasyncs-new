...
@endphp
                    <tr>
                        ...
                        <td class="{{ $class }}"><a class="text-blue-300 hover:underline" href="/mode/{{ $race->mode->id }}">@if($race->team_race == 1)coop @endif
@if($race->spoiler_race == 1)spoiler @endif{{ $race->mode->name }}</a></td>
